...
class ArchiveSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        midi_urls = list(set([url for url in anchor_hrefs if url.lower().endswith('.mid')]))
        ...
        img_els = list(set([url for url in response.css("img::attr(src)").getall()]))#this is maybe a bit specific to wayback machine scraping
