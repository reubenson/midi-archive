...
Archives seem to have come into [a kind of fashion in the late 20th century](https://books.google.com/ngrams/graph?content=archive&year_start=1900&year_end=2019&corpus=en-2019&smoothing=3), and increasingly so as of late. There's something knowable, certain, and grounding about the idea of archives, especially in a time of greater existential and perceieved precarity. The training procedures of AI foundation models like GPT have a close relationship with archives too, but instead need their accessibility, volume, and givenness, which allows archives to be composed and instrumentalized as training sets.
